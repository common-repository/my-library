...
function my_library_conf() {
    if ( isset($_POST['submit']) ) {
        ...
        update_option('my-library-target-blank', $_POST['target-blank']);
    }
    $target_blank = get_option('my-library-target-blank');
?>
<div class="wrap">
    ...
    <form action="" method="post" id="my-library-conf">
        ...
        <p><label for="target-blank"><?php _e('Open Links In New Tab/Page'); ?>:</label>
        <input id="target-blank" name="target-blank" type="checkbox" <?php echo ($target_blank ? 'checked' : ''); ?>></p>
